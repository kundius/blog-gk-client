...
import { ApolloClient, ApolloLink, HttpLink, GraphQLRequest, InMemoryCache, NormalizedCacheObject } from '@apollo/client'
...
export function createLink (params: ApolloParams) {
  // TODO: Workaround. https://github.com/jaydenseric/apollo-upload-client/issues/213#issuecomment-670089925
...
export function createApolloClient (
  ...
  const cache = new InMemoryCache({
    possibleTypes: {
      User: ['Contractor', 'Customer', 'Administrator'],
